...
def main():
    ...
    dMsAge = dictSummary["dictMainSequenceArrival"]["mean"]
    axis.axvline(dMsAge, color=S_COLOR_MAINSEQUENCE, linestyle=(0, (5, 1)),
                 linewidth=1.8,
                 label=f"main-sequence arrival ({1000 * dMsAge:.0f} Myr)")
